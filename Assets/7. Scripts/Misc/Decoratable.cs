...
/// <summary>
/// Decoratable DamageSource type. Setting / assigning works as usual, getting the value
/// passes the value through a Filter stack which can alter it before being returned.
/// This allows for temporary changes and effects to be applied to the value with low coupling.
/// </summary>
/// <example>
...
/// public class Player : MonoBehaviour
/// {
/// 	DecoratableDamagesource damageResistance = new DecoratableDamagesource(1);
/// }
/// 
/// public class PoisonEffect : MonoBehaviour
/// {
...
/// 	}
/// 	
/// 	DamageSource ModulateDR(DamageSource dr)
/// 	{
/// 		return dr * damageResistanceFactor;
/// 	}
/// }
...
/// </example>
[System.Serializable]
public class DecoratableDamagesource
{
	/// <summary>
	/// Signature of a Filter delegate. Accepts the value so far, returns the modified value.
	/// </summary>
	public delegate DamageSource Filter(DamageSource value);
	...
	/// bypasses the Filter stack.
	/// </summary>
    public DamageSource rawValue;

	public DecoratableDamagesource(DamageSource v)
	{
		rawValue = v;
	}

	/// <summary>
	/// Allow implicit conversions from a DecoratableDamagesource value to its wrapped type.
	/// </summary>
	public static implicit operator DamageSource(DecoratableDamagesource d)
	{
		return d.value;
	}
