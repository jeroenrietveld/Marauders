...
public class ArmoryState : MenuStateBase
{
    public ArmoryState()
    {
        ...
        GameObject.Find("TextButtonA").gameObject.GetComponent<TextMesh>().text = Locale.Current["text_select"];
        GameObject.Find("TextButtonB").gameObject.GetComponent<TextMesh>().text = Locale.Current["text_back"];
        GameObject.Find("MarauderSelectText").gameObject.GetComponent<TextMesh>().text = Locale.Current["select_your_marauder"];
    }
